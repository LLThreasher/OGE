...
namespace OneGame::Engine::Terrain
{
	...
	// allocate chunk -> generate terrain queue -> build mesh queue -> built chunk meshes -> 
	// upload with streaming manager -> remove built chunk meshes -> resident chunk
	// any state -> destroy chunk
	struct TerrainData
	{
	...
	public:
		...
		void SetTerrainGenChunkBudget(int chunkBudget)
		{
