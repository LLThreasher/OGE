#include "oge/runtime/terrain/terrain_renderer.hpp"

#include <limits>

#include "oge/runtime/renderer.hpp"
#include "oge/runtime/terrain/block_registry.hpp"

#include "oge/runtime/terrain/subsystem_terrain.hpp"
#include "oge/runtime/ui/objects.hpp"
#include "oge/runtime/components.hpp"
...
void TerrainRenderer::onUpdate(FRendererState& ctx)
{
    ...
    m_terrainMeshScheduler.SubmitVisibleChunks(terrainData, m_terrainPData, ctx.world, ctx.submissionQueue.View<CmdDrawTerrainMeshOpaque>());
}
