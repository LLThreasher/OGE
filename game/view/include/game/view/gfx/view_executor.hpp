...
class ViewExecutor
{
   public:
    ...
    void Update(float dt)
    {
        ...
        m_queue.Add<CmdAddView>(GameViewType::Overlay, IRect16{{0, 0}, ctx.backend.SwapchainExtent()});
