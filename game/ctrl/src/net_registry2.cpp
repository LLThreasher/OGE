...
// #include "game/replication_registry2.hpp"
...
// {
//     world.ctx().emplace<EntityNetStream>();

//     world.on_construct<ReplicatedTag>()
//         .template connect<
//             +[](entt::registry& world, entt::entity e)
//             {
//                 LOG_DEBUG("create entity {}", static_cast<uint64_t>(e));

//                 world.ctx()
//                     .template get<EntityNetStream>()
...
//             +[](entt::registry& world, entt::entity e)
//             {
//                 LOG_DEBUG("destroy entity {}", static_cast<uint64_t>(e));
...
// void game::ApplyEntityReplicationEvents(entt::registry& world)
// {
//     auto* stream = world.ctx().find<EntityNetStream>();
//     if (!stream)
//     {
//         return;
//     }

//     static EntityNetStream::Cursor cursor = 0;
...
//                 {
//                     auto created = world.create(event.entity);
//                     assert(created == event.entity);
//                 }
