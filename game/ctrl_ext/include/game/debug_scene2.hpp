...
class DebugScene2 : public GraphicalScene
{
    ...
    void AddWidgetInput(oge::runtime::AssetContext assets)
    {
        ...
        auto m_widgetInputDef = InputDef{
            .target = m_world.try_get<input::PlayerInputStream>(m_player)};
   ...
   public:
                ...
                AnythingFactory& af) override
    {
        ...
        // auto vpe = ui::CreateGameView(m_world, {math::vec2{0, 0},
        // math::vec2{1, 1}}); m_player = ComponentPlayer::CreatePlayer(m_world,
        // {20.f, 20.f, 20.f});
        // {
        ...
        //     m_world.get<ComponentPerspectiveCamera>(m_player); pcam.fov =
        //     math::radians(45.f);
        // }
        ...
        // //     math::vec2{0.1f, 0.1f * context.backend.SwapchainAspect()});
        ...
        //                             math::vec2{0.5f - 0.01f, 0.5f - 0.01f *
        //                             assets.backend.SwapchainAspect()},
        //                             math::vec2{0.01f, 0.01f *
        //                             assets.backend.SwapchainAspect()});
    ...
    void Update(Frame f) override
    {
        ...
        //     auto& pcam = m_world.get<const
        //     ComponentPerspectiveCamera>(m_player); auto m_widgetInputDef =
        //     InputDef{.target =
        //     m_world.try_get<input::PlayerInputStream>(m_player)};
        //     m_widgetInputDef.vfov = -pcam.fov;
        //     m_widgetInputDef.hfov = 2.f * math::atan(math::tan(pcam.fov
        //     / 2.f) * pcam.aspect);
